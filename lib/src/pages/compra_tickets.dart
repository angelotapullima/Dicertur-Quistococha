...
class CompraTicketPage extends StatefulWidget {
  const CompraTicketPage({Key? key}) : super(key: key);

  @override
  _CompraTicketPageState createState() => _CompraTicketPageState();
}

class _CompraTicketPageState extends State<CompraTicketPage> {
